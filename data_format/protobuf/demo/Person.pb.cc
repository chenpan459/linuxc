...
const uint32_t TableStruct_Person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::dong::PersonInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::dong::PersonInfo, name_),
  PROTOBUF_FIELD_OFFSET(::dong::PersonInfo, age_),
  PROTOBUF_FIELD_OFFSET(::dong::PersonInfo, phone_num_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::dong::Person, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::dong::Person, people_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::dong::PersonInfo)},
  { 9, -1, -1, sizeof(::dong::Person)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::dong::_PersonInfo_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::dong::_Person_default_instance_),
};

const char descriptor_table_protodef_Person_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Person.proto\022\004dong\":\n\nPersonInfo\022\014\n\004na"
  "me\030\001 \001(\t\022\013\n\003age\030\002 \001(\r\022\021\n\tphone_num\030\003 \001(\r"
  "\"*\n\006Person\022 \n\006people\030\001 \003(\0132\020.dong.Person"
  "Infob\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Person_2eproto = {
  false, false, 132, descriptor_table_protodef_Person_2eproto, "Person.proto", 
...
PersonInfo::PersonInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:dong.PersonInfo)
}
PersonInfo::PersonInfo(const PersonInfo& from)
  ...
  ::memcpy(&age_, &from.age_,
    static_cast<size_t>(reinterpret_cast<char*>(&phone_num_) -
    reinterpret_cast<char*>(&age_)) + sizeof(phone_num_));
  // @@protoc_insertion_point(copy_constructor:dong.PersonInfo)
}
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&phone_num_) -
    reinterpret_cast<char*>(&age_)) + sizeof(phone_num_));
}

PersonInfo::~PersonInfo() {
  // @@protoc_insertion_point(destructor:dong.PersonInfo)
...
// @@protoc_insertion_point(message_clear_start:dong.PersonInfo)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "dong.PersonInfo.name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          phone_num_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* PersonInfo::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:dong.PersonInfo)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->_internal_phone_num() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(3, this->_internal_phone_num(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dong.PersonInfo)
  return target;
}

size_t PersonInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dong.PersonInfo)
  size_t total_size = 0;
  ...
  // uint32 phone_num = 3;
  if (this->_internal_phone_num() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32SizePlusOne(this->_internal_phone_num());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:dong.PersonInfo)
...
// @@protoc_insertion_point(class_specific_copy_from_start:dong.PersonInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void PersonInfo::InternalSwap(PersonInfo* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(PersonInfo, phone_num_)
      + sizeof(PersonInfo::phone_num_)
...
Person::Person(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:dong.Person)
}
Person::Person(const Person& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      people_(from.people_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:dong.Person)
}
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:dong.Person)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void Person::Clear() {
// @@protoc_insertion_point(message_clear_start:dong.Person)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* Person::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:dong.Person)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dong.Person)
  return target;
}

size_t Person::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dong.Person)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:dong.Person)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:dong.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::dong::PersonInfo* Arena::CreateMaybeMessage< ::dong::PersonInfo >(Arena* arena) {
  return Arena::CreateMessageInternal< ::dong::PersonInfo >(arena);
}
template<> PROTOBUF_NOINLINE ::dong::Person* Arena::CreateMaybeMessage< ::dong::Person >(Arena* arena) {
  return Arena::CreateMessageInternal< ::dong::Person >(arena);
}
