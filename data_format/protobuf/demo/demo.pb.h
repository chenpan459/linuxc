...
PROTOBUF_NAMESPACE_OPEN
template<> ::demo::Any* Arena::CreateMaybeMessage<::demo::Any>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace demo {
...
class Any final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:demo.Any) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:demo.Any)
 private:
  class _Internal;
...
inline const std::string& Any::type_url() const {
  // @@protoc_insertion_point(field_get:demo.Any.type_url)
...
void Any::set_type_url(ArgT0&& arg0, ArgT... args) {
 ...
 type_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:demo.Any.type_url)
}
inline std::string* Any::mutable_type_url() {
  std::string* _s = _internal_mutable_type_url();
  // @@protoc_insertion_point(field_mutable:demo.Any.type_url)
  return _s;
}
...
inline std::string* Any::release_type_url() {
  // @@protoc_insertion_point(field_release:demo.Any.type_url)
...
inline void Any::set_allocated_type_url(std::string* type_url) {
  ...
  // @@protoc_insertion_point(field_set_allocated:demo.Any.type_url)
}
